...
router.get('/', async (req, res) => {
    try {
      ...
      SELECT 
        sailor_name,
        MAX(total_wave) as best_wave_score,
        MAX(total_jump) as best_jump_score,
        event_name,
        category_code
    ...
    `;
        ...
        query += ' GROUP BY sailor_name, event_name, category_code ORDER BY best_wave_score DESC';
...
//# sourceMappingURL=best-jumps-waves.js.map